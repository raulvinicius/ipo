									...
									<li class="col-xs-offset-2 col-xs-8 col-sm-offset-0 col-sm-6 col-md-4">
									    <div class="bg-li">
									        ...
									        <figure class="depois">
									            ...
									            <img src="<?php echo bloginfo('template_url') ?>/img/ipo-tratamentos-reabilitacao-depois.jpg" />
									        </figure>

									        <figure class="antes">
									            <div class="filtro-antes"></div>
									            <img src="<?php echo bloginfo('template_url') ?>/img/ipo-tratamentos-reabilitacao-antes.jpg" />
